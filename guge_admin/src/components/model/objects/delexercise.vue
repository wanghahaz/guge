	...
	<div v-show="show" class="model">
		<div class="addcompany">
			...
			<div class="model_content">
				<span style="font-size: 16px;color: #FF4545;">您确定删除吗？</span>
			</div>
			
			<div>
				<Divider style="width: 90%;margin:auto;" />
				<div class="model_operation">
					<button @click="deleteRightRecordById" class="model_operation_confirm">确定</button>
...
<script>
	export default {
		...
		methods:{
			//删除申请
			deleteRightRecordById(){
				this.$axios.Objects.deleteRightRecordById({
					data: {
						id:this.userid /1
					},
					version: '2.0'
