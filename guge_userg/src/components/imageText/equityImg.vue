<template>
  <div class="textone">
    <div v-html="imagersText" class="word" v-show="showTwo" @click="previewImage">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      stimulateImg() {
        Indicator.open();
        this.$http.post('/selectContentByName', {
          data: {
            contentName: this.textImg
          },
          version: "2.0"
        }).then(res => {
          console.log(res);
          ...
          if (res.data.result.contentText == null) {
            ...
            this.imagersText = res.data.result.contentText;
            this.showOne = false;
            this.showTwo = true;
          }
        })
